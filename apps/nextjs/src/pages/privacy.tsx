  ...
  return (
    <main className="container flex flex-col items-start justify-center min-h-screen space-y-4 max-w-5xl p-4 mx-auto">
      ...
      <p>
        ...
        Personal Information if anyone decided to use our Service, the Probable
        Pitcher website and mobile app.
      </p>
      <p>
      ...
      <p>
        ...
        an anonymous unique identifier. These are sent to your browser or device
        from the website or application service backend that you visit and are
        stored on your computer&apos;s hard drive.
      </p>
      <p>
        Our service uses these &quot;cookies&quot; to collect information and to
